              ...
              <div className="flex items-start flex-col gap-4 mb-6">
                ...
                <div>
                  <ul className="list-disc ml-5 sm:ml-10 text-md sm:text-xl space-y-2 text-gray-700">
                    <li>Our fleet has a wide range of equipment</li>
                    <li>
                      Transporting various goods to the location you specify.
                    </li>
                    <li>Timely delivery to your site.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              <div className="flex items-start  flex-col gap-4 mb-6">
                ...
                <div className="flex items-start justify-start">
                  <ul className="list-disc ml-5 sm:ml-10  text-md sm:text-xl space-y-2  text-gray-700">
                    <li>
                      Extensive experience in the production of construction
                      materials.
                    </li>
                    <li>
                      Produce goods with less time and resource expenditure.
                    </li>
                    <li>
                      Years of expertise in construction material manufacturing
                      enable us to optimize production, reducing both time and
